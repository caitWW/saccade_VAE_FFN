...
class Encoder(nn.Module):
    ...
    def __init__(self, channels, ch=64, latent_channels=512):
        ...
        self.res_down_block5 = ResDown(16 * ch, 32 * ch)
        self.conv_mu = nn.Conv2d(32 * ch, latent_channels, 4, 1)
        self.conv_log_var = nn.Conv2d(32 * ch, latent_channels, 4, 1)
        self.act_fnc = nn.ELU()
...
class Decoder(nn.Module):
    ...
    def __init__(self, channels, ch=64, latent_channels=512):
        ...
        self.conv_t_up = nn.ConvTranspose2d(latent_channels, ch * 32, 4, 1)
        self.res_up_block1 = ResUp(ch * 32, ch * 16)
        self.res_up_block2 = ResUp(ch * 16, ch * 8)
        self.res_up_block3 = ResUp(ch * 8, ch * 4)
        self.res_up_block4 = ResUp(ch * 4, ch * 2)
        self.res_up_block5 = ResUp(ch * 2, ch)
